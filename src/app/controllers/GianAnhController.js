...
class GianAnhController {
    // [GET] /gian-anh
    gianAnh(req, res, next) {
        res.render('gian-anh')
    }
    // [POST] /gian-anh
    postXY(req, res, next) {
        ...
        res.render('gian-anh', { htmls, arrayS, X })
    }
    // [POST] /gian-anh/ket-qua
    tinhToan(req, res, next) {
        ...
        res.render('gian-anh', { result })
    }
}

module.exports = new GianAnhController;